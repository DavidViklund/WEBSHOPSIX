...
const CheckOut = () => {
  ...
  const getTotalPrice = () => {
    return orderSummaryItems.reduce((total, item) => total + item.price * item.quantity, 0).toFixed(2);
  };
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className="flex flex-col">
        ...
        <p className="font-bold text-center mb-8">Order number: #{orderNumber}</p>
      </div>
        ...
        {orderSummaryItems.length === 0 ? (
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="flex flex-col justify-start my-4">
              <p className="font-bold text-right">Order total: {getTotalPrice()}$</p>
            </div>
          </div>
        )}
      </div>
