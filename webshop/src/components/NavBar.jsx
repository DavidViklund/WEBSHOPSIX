  ...
  return (
    <div className="NavBarContainer flex flex-col p-4 justify-center bg-greyscale-surface-default/50 rounded-xl">
      <div className="closedNav flex items-center justify-between">
        ...
        <div className="iconBox lg:hidden" onClick={toggleMenu} style={{ cursor: 'pointer' }}>
          <span className="material-symbols-outlined flex items-center justify-center w-10 h-10">{isOpen ? 'menu_open' : 'menu'}</span>
        </div>
