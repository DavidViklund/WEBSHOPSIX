          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-8 max-w-[500px]">
              ...
              <div className=" flex flex-col gap-2">
                ...
                <p>
                  Vi har strävat efter en enkel och UI-säker design. Detta för
                  att inte lägga för mycket tid på designval men också göra det
                  enklare att koda. Se
                  <a
                ...
                <p>
                  Tack vare att Jonas hade gjort ett befintligt editerbart
                  designsystem kunde vi snabbt komma igång med designen och
                  implementera vårga färger, fonter etc.
                </p>
              ...
              <div className=" flex flex-col gap-2">
                ...
                <p>
                  Vi använde vår primära färg strategiskt för att framhäva
                  viktiga åtgärder (CTA) och undvika konkurrens med andra
                  färger.
                </p>
              ...
              <div className=" flex flex-col gap-2">
                ...
                <p>
                  Vi använde fonterna Montserrat och Roboto. Båda har raka
                  linjer och mjuka former, vilket gör dem lättlästa. Här la vi
                  till en lineheight som främjar läsbarheten och matchar vårt
                  spacingsystem.
                </p>
          ...
          <div className="flex flex-col gap-8 max-w-[500px]">
            ...
            <div className=" flex flex-col gap-2">
              ...
              <p>
                ...
                projekt där tid, kvalitet och kostnad styr. Till exempel har du
                kanske inte budget för fancy features eller tid att finjustera
                designen.
              </p>
            ...
            <div className=" flex flex-col gap-2">
              ...
              <p>
                ...
                bättre till kod. Till exempel: Vikten av att designa utifrån
                befintlig data för att se hur långa texter etc kan vara i din
                design. Den hade också kunnat bli lite roligare..
              </p>
            </div>
          </div>
        </div>
